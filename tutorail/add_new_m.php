...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO `médecins`(`first_name`, `last_name`, `email`, `gender`, `password`, `age`) 
            VALUES ('$first_name','$last_name','$email','$gender','$password',$age)";

    $result = mysqli_query($conn, $sql);

    if ($result) {
        header("Location: index_m.php?msg=New record created successfully");
        exit();
    } else {
    ...
    <div class="col">
        ...
        <input type="number" class="form-control" name="age" placeholder="Age" required>
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="index_m.php" class="btn btn-danger btn-cancel">Cancel</a>
