...
$message = ""; // Initialiser le message à vide
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($password)) {
        $message = "Erreur : Veuillez saisir un mot de passe";
    } else {
        // Requête SQL pour insérer un nouveau patient
        $sql = "INSERT INTO `crud` (`first_name`, `last_name`, `email`, `gender`, `password`, `age`) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-footer text-center py-2">
                        <div class="small">
                            <a href="Log_in_p.php">Vous avez déjà un compte? Connectez-vous</a>
                        </div>
                    </div>
                </div>
            </div>
