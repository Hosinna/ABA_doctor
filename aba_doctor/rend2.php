...
<br><br><br>
  <div class="container">
    <h1></h1>
    <img src="images/doc-2.png"width="20%">
<p>
    <div class="doctor">
      <h2>Dr. SOUAD CHEDDADI EP KIMOUR </h2>
      <p>Spécialité : Gynécologue</p>
      <p>Horaires : Lundi à jeudi, 9h00 - 18h00</p>
      <p>Adresse : El Hadjar, Annaba</p>
      <button onclick="takeAppointment('Dr. Marie Leclerc')">Prendre rendez-vous</button>
    </div>
    </p>
