...
<body>
    <div class="container">
        <h1>Maladies psychiques et mentales</h1>
      
        <!-- Section: Maladies psychiques et mentales -->
        <div class="section">
            <div class="content">
                ...
                <div class="info-section">
                    <p>Les maladies psychiques et mentales affectent le fonctionnement mental, émotionnel et comportemental d'une personne.</p>
                    <h3>Types de maladies psychiques et mentales</h3>
                    <ul>
                        <li>Dépression</li>
                        <li>Anxiété</li>
                        <li>Schizophrénie</li>
                    ...
                    <h3>Traitements</h3>
                    <p>Les traitements peuvent inclure une thérapie, des médicaments et un soutien social.</p>
