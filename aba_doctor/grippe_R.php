...
<body>
    ...
    <div class="container">
        ...
        <div class="symptoms">
            ...
            <p class="green-text">Les symptômes observés ne sont pas suffisants pour indiquer une grippe. Veuillez consulter un médecin pour un diagnostic précis.</p>
        </div>

        <div id="diagnosis" class="diagnosis"></div>

        <h2>Description de la grippe :</h2>
        <div class="img-container">
            <img src="images/grippe.jpg" alt="Symboles de la grippe">
        </div>
        <p>La grippe est une maladie virale respiratoire contagieuse. Elle se manifeste généralement par les symptômes suivants :</p>
        <ul>
            <li>Fièvre</li>
            <li>Frissons</li>
            <li>Maux de tête</li>
