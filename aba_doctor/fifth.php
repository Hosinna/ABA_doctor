...
<div class="container">
    <div class="content">
        <div class="image-container">
            <img src="images/fifth_photo.png" alt="Image de la grippe">
        </div>
        ...
        <h2 style="text">Symptômes</h2>
            <div class="symptom">
                <label for="symptom21">•	Respiration sifflante:</label>
            ...
            <div class="symptom">
                <label for="symptom22">•	Essoufflement:</label>
                <input type="radio" id="symptom21_yes" name="symptom22" value="oui">
            ...
            <div class="symptom">
                <label for="symptom23">•	Toux sèche:</label>
            ...
            <div class="symptom">
                <label for="symptom24">•	Oppression thoracique:</label>
            ...
            <div class="symptom">
                <label for="symptom25">•	Fatigue:</label>
...
<script>
    ...
    function suivant() {
        ...
        if (count >= 4) {
            window.location.href = 'Asthume.php';
        } else {
            window.location.href = 'sixth.php';
        }
    }
</script>
</body>
