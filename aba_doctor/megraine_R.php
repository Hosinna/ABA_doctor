...
<body>
    <div class="container">
        ...
        <div class="symptoms">
            <p class="green-text">Les symptômes observés ne sont pas suffisants pour indiquer une migraine. Veuillez consulter un médecin pour un diagnostic précis.</p>
        </div>

        <div id="diagnosis" class="diagnosis"></div>

        <h2>Description de la migraine :</h2>
        <div class="img-container">
            <img src="images/migraine.jpg" alt="Symboles de la migraine">
        </div>
        <p>La migraine est un type de mal de tête intense qui peut causer des symptômes tels que :</p>
        <ul>
            <li>Douleur pulsatile ou lancinante</li>
            <li>Sensibilité à la lumière et au son</li>
            <li>Nausées et vomissements</li>
            <li>Auras visuelles (comme des taches lumineuses ou des lignes ondulées)</li>
        </ul>
        ...
        <p style=" text-align: center;
            font-weight: bold;">Importance de la consultation médicale : Il est essentiel de consulter un professionnel de la santé pour un diagnostic précis en cas de symptômes de migraine. Cela permet d'obtenir un traitement approprié pour soulager la douleur et de recevoir des conseils sur la gestion de la migraine.</p>
       <br>
